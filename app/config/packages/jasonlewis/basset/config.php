    ...
    */
    ...
    'collections' => array(
        'backend' => function($collection)
        {
            ...
            {
                $collection->add('backend-bootstrap.min.css');
                $collection->add('backend-bootstrap-reset.css');
                $collection->add('backend-style-responsive.css');
                $collection->add('font-awesome.css');
                $collection->add('backend-style.css');
                $collection->add('backend-custom.css');
            });
